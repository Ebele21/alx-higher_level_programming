...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def capture_stdout(rect, method):
        ...
        Args:
            rect (Rectangle): it is the Rectangle to print to stdout.
            method (str): it is the method to run on rect.
        Returns:
            it returns the text printed to stdout by calling method on sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
